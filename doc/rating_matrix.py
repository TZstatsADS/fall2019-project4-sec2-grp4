...
def count_user(n, dataframe):
  usercount = dataframe.movieId.value_counts()
  dataframe_updated = dataframe[dataframe.index.isin(usercount[usercount > n].index)]
  return dataframe_updated
#title, genres, timestamp, count_matching, count_user functions
